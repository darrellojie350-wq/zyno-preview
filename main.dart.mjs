...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      nH: () => new TextDecoder(),
      nI: () => globalThis.WebSocket.CLOSED,
      ...
      oI: () => globalThis.WebSocket.CLOSING,
      oJ: (x0,x1,x2) => x0.addEventListener(x1,x2),
      oK: x0 => x0.length,
      p: b => !!b,
      ...
      rI: (x0,x1) => { x0.binaryType = x1 },
      rJ: x0 => x0.status,
      rK: (x0,x1) => x0.canShare(x1),
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
      ...
      sI: (x0,x1) => x0.getRandomValues(x1),
      sJ: x0 => x0.response,
      sK: (x0,x1) => x0.share(x1),
      t: (o, p, v) => o[p] = v,
      ...
      tI: () => globalThis.crypto,
      tJ: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      tK: x0 => x0.message,
      u: () => [],
      ...
      uI: l => new DataView(new ArrayBuffer(l)),
      ...
      vI: (a, s, e) => a.splice(s, e),
      vJ: () => new XMLHttpRequest(),
      vK: x0 => x0.length,
      ...
      xJ: () => globalThis.window.navigator.userAgent,
      xK: x0 => x0.value,
      ...
      yJ: (x0,x1,x2) => x0.insertBefore(x1,x2),
      yK: x0 => x0.done,
